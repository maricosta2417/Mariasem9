        ...
        alternativas: [
            {
                ...
                afirmacao: [
                "Sim, pois e o meion tecnologico mais utilizado pela sociedade.",
                ""
                ]
            },
            {
                ...
                afirmacao: [
                 "Nao, pois atualmente a inteligencia artificial esta crescendo muito",
                 ""
                ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao:[
                "Sim, os meios digitais sao utilizados em todos os meios digitais citados a cima.",
                ""
            ]
            },
            {
                ...
                afirmacao: [
                "Nao, pois a inteligencia artificial e utilizada em um grande todo dos meios digitais.",
                ""
                ]
            }
        ...
        alternativas: [
            {
                texto: "positivos ",
                afirmacao: [
                "Nao, pois possui muitos pontos negativos tambem.",
                ""
            ]
            },
            {
                texto:"negativos",
                afirmacao:[
                 "Nao, pois possui muitos pontos positivos. tambem",
                 ""
                ]
            },
            {
                ...
                afirmacao:[
                 "Sim, pois o fator de como ela e usada interfere muitos nesses dois pontos.",
                 ""
                ]
            }  
        ]
        ...
        alternativas: [
            {
                texto: "Talvez",
                afirmacao:[
                 "Sim, pois com sua evolucao a IA talvez conseguira alcancar a capacidade de um cerebro humano.",
                ""
                ]
            ...
            },
            {
                texto:"Não, pois a mesma não possuí evolução o sufiente para executar determinadas tarefas.",
                 afirmacao: [
                 "Nao, pois talvez com evolucoes futuras  IA podera conseguira alcancar essas tarefas.",
                ""
                ]
            },
            {
                ...
                afirmacao: [
                "Nao, pois esses dados ainda estao em estudo.",
            ""
            ]
            }
        ]
        ...
        alternativas: [
            {
                ...
                afirmacao:[
                 "Sim, pois o IA e capaz de proporcionar tudo isso.",
                ""
                ]
            },
            {
                ...
                afirmacao: [
                    "Nao,pois ha sim muitos beneficios.",
                    " "
                ]
            }
        ]
